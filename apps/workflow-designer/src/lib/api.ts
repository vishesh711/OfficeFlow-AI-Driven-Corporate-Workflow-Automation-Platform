...
export const workflowApi = {
  ...
  executeWorkflow: (
    id: string,
    context?: { employeeId?: string; data?: Record<string, any>; variables?: Record<string, any> }
  ) =>
...
export const monitoringApi = {
  ...
  getWorkflowRun: (runId: string) => apiClient.get<WorkflowRun>(`/monitoring/runs/${runId}`),
  ...
  getSystemHealth: () => apiClient.get<SystemHealth>('/monitoring/health'),
  pauseWorkflowRun: (runId: string) => apiClient.post(`/monitoring/runs/${runId}/pause`),
  resumeWorkflowRun: (runId: string) => apiClient.post(`/monitoring/runs/${runId}/resume`),
  cancelWorkflowRun: (runId: string) => apiClient.post(`/monitoring/runs/${runId}/cancel`),
  retryWorkflowRun: (runId: string) => apiClient.post(`/monitoring/runs/${runId}/retry`),
};
...
export const adminApi = {
  ...
  getOrganization: (orgId: string) => apiClient.get<Organization>(`/admin/organizations/${orgId}`),
  createOrganization: (
    org: Omit<Organization, 'id' | 'userCount' | 'workflowCount' | 'createdAt' | 'updatedAt'>
  ...
  deleteOrganization: (orgId: string) => apiClient.delete(`/admin/organizations/${orgId}`),
  ...
  createIntegrationCredential: (
    credential: Omit<IntegrationCredential, 'id' | 'createdAt' | 'updatedAt'>
  ...
  testIntegrationCredential: (credentialId: string) =>
    apiClient.post<{ success: boolean; error?: string }>(
      `/admin/integrations/${credentialId}/test`
    ),
